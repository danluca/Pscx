...
| `fhex` | `Pscx\Format-Hex` | All | Default unless collision (`OverrideExistingAliases`) |
...
| `igc` | `Invoke-GC` | All | Default unless collision (`OverrideExistingAliases`) |
| `ln` | `New-HardLink` | Windows | Default unless collision (`OverrideExistingAliases`) |
| `lorem` | `Pscx\Get-LoremIpsum` | All | Default unless collision (`OverrideExistingAliases`) |
