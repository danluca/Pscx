    ...
    public class AssemblyCacheProvider : ContainerCmdletProvider {
        ...
        protected override Collection<PSDriveInfo> InitializeDefaultDrives() {
            var drives = new Collection<PSDriveInfo> {
                new(GAC_DRIVENAME, ProviderInfo, Enum.GetName(typeof(AssemblyCacheType), AssemblyCacheType.Gac), Errors.AssemblyCacheGacDriveDescription, null)
            };
        ...
        protected override void InvokeDefaultAction(string path) {
            using (PscxProviderContext<AssemblyCacheProvider>.Enter(this)) {
                ...
                if (path == BACKSLASH) {
                    if (!ShouldContinue(Errors.AssemblyCacheLoadEntireGac, "Invoke-Item")) {
        ...
        private bool MatchesDynamicParameterFilters(AssemblyName assemblyName) {
            ...
            if (!Equals(assemblyName.CultureInfo, ParameterCultureInfo)) {
                return false;
            }
        ...
        private ICollection<AssemblyName> GetAssemblyNames(string path) {
            ...
            return cache[path] ?? Array.Empty<AssemblyName>();
        }
