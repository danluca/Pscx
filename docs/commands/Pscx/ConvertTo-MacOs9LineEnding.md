...
title: ConvertTo-MacOs9LineEnding
---
...
```
ConvertTo-MacOs9LineEnding [-Path] <PscxPathInfo[]> [-Destination] <string>
...
```
ConvertTo-MacOs9LineEnding [-LiteralPath] <PscxPathInfo[]> [-Destination] <string>
 [[-Encoding] <StringEncodingParameter>] [-Force] [-NoClobber] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```powershell
Get-Help ConvertTo-MacOs9LineEnding -Full
```
