...
Copy-Item $solDir/Pscx/bin/$configuration/net9.0/Apps . -Recurse -Force
Copy-Item $solDir/Pscx/bin/$configuration/net9.0/NodaTime.* . -Force
Copy-Item $solDir/Pscx.Win/bin/$configuration/net9.0/SevenZipSharp.* . -Force
